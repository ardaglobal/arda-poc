...
var (
	...
	fd_MsgPayRentResponse_success             protoreflect.FieldDescriptor
	fd_MsgPayRentResponse_amount_paid         protoreflect.FieldDescriptor
	fd_MsgPayRentResponse_amount_disbursed    protoreflect.FieldDescriptor
	fd_MsgPayRentResponse_outstanding_cleared protoreflect.FieldDescriptor
)

func init() {
	file_ardapoc_rent_tx_proto_init()
	md_MsgPayRentResponse = File_ardapoc_rent_tx_proto.Messages().ByName("MsgPayRentResponse")
	fd_MsgPayRentResponse_success = md_MsgPayRentResponse.Fields().ByName("success")
	fd_MsgPayRentResponse_amount_paid = md_MsgPayRentResponse.Fields().ByName("amount_paid")
	fd_MsgPayRentResponse_amount_disbursed = md_MsgPayRentResponse.Fields().ByName("amount_disbursed")
	fd_MsgPayRentResponse_outstanding_cleared = md_MsgPayRentResponse.Fields().ByName("outstanding_cleared")
}
...
func (x *fastReflection_MsgPayRentResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Success != false {
		...
		if !f(fd_MsgPayRentResponse_success, value) {
			return
		}
	}
	if x.AmountPaid != "" {
		value := protoreflect.ValueOfString(x.AmountPaid)
		if !f(fd_MsgPayRentResponse_amount_paid, value) {
			return
		}
	}
	if x.AmountDisbursed != "" {
		value := protoreflect.ValueOfString(x.AmountDisbursed)
		if !f(fd_MsgPayRentResponse_amount_disbursed, value) {
			return
		}
	}
	if x.OutstandingCleared != int32(0) {
		value := protoreflect.ValueOfInt32(x.OutstandingCleared)
		if !f(fd_MsgPayRentResponse_outstanding_cleared, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgPayRentResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ardapoc.rent.MsgPayRentResponse.success":
		return x.Success != false
	case "ardapoc.rent.MsgPayRentResponse.amount_paid":
		return x.AmountPaid != ""
	case "ardapoc.rent.MsgPayRentResponse.amount_disbursed":
		return x.AmountDisbursed != ""
	case "ardapoc.rent.MsgPayRentResponse.outstanding_cleared":
		return x.OutstandingCleared != int32(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgPayRentResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "ardapoc.rent.MsgPayRentResponse.amount_paid":
		...
		return protoreflect.ValueOfString(value)
	case "ardapoc.rent.MsgPayRentResponse.amount_disbursed":
		value := x.AmountDisbursed
		return protoreflect.ValueOfString(value)
	case "ardapoc.rent.MsgPayRentResponse.outstanding_cleared":
		value := x.OutstandingCleared
...
func (x *fastReflection_MsgPayRentResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "ardapoc.rent.MsgPayRentResponse.amount_paid":
		x.AmountPaid = value.Interface().(string)
	case "ardapoc.rent.MsgPayRentResponse.amount_disbursed":
		x.AmountDisbursed = value.Interface().(string)
	case "ardapoc.rent.MsgPayRentResponse.outstanding_cleared":
		x.OutstandingCleared = int32(value.Int())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ardapoc.rent.MsgPayRentResponse"))
		}
...
func (x *fastReflection_MsgPayRentResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "ardapoc.rent.MsgPayRentResponse.success":
		panic(fmt.Errorf("field success of message ardapoc.rent.MsgPayRentResponse is not mutable"))
	case "ardapoc.rent.MsgPayRentResponse.amount_paid":
		panic(fmt.Errorf("field amount_paid of message ardapoc.rent.MsgPayRentResponse is not mutable"))
	case "ardapoc.rent.MsgPayRentResponse.amount_disbursed":
		panic(fmt.Errorf("field amount_disbursed of message ardapoc.rent.MsgPayRentResponse is not mutable"))
	case "ardapoc.rent.MsgPayRentResponse.outstanding_cleared":
		panic(fmt.Errorf("field outstanding_cleared of message ardapoc.rent.MsgPayRentResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ardapoc.rent.MsgPayRentResponse"))
		}
...
func (x *fastReflection_MsgPayRentResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.AmountDisbursed)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.OutstandingCleared != 0 {
			n += 1 + runtime.Sov(uint64(x.OutstandingCleared))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.OutstandingCleared != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.OutstandingCleared))
			i--
			dAtA[i] = 0x20
		}
		if len(x.AmountDisbursed) > 0 {
			i -= len(x.AmountDisbursed)
			copy(dAtA[i:], x.AmountDisbursed)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.AmountDisbursed)))
			i--
			dAtA[i] = 0x1a
		}
		if len(x.AmountPaid) > 0 {
			i -= len(x.AmountPaid)
			copy(dAtA[i:], x.AmountPaid)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.AmountPaid)))
			i--
			dAtA[i] = 0x12
		}
		if x.Success {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AmountPaid", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.AmountPaid = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AmountDisbursed", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.AmountDisbursed = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 4:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field OutstandingCleared", wireType)
				}
				x.OutstandingCleared = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.OutstandingCleared |= int32(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
var (
	md_MsgCancelCancellation         protoreflect.MessageDescriptor
	fd_MsgCancelCancellation_creator protoreflect.FieldDescriptor
	fd_MsgCancelCancellation_leaseId protoreflect.FieldDescriptor
)

func init() {
	file_ardapoc_rent_tx_proto_init()
	md_MsgCancelCancellation = File_ardapoc_rent_tx_proto.Messages().ByName("MsgCancelCancellation")
	fd_MsgCancelCancellation_creator = md_MsgCancelCancellation.Fields().ByName("creator")
	fd_MsgCancelCancellation_leaseId = md_MsgCancelCancellation.Fields().ByName("leaseId")
}

var _ protoreflect.Message = (*fastReflection_MsgCancelCancellation)(nil)

type fastReflection_MsgCancelCancellation MsgCancelCancellation

func (x *MsgCancelCancellation) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgCancelCancellation)(x)
}

func (x *MsgCancelCancellation) slowProtoReflect() protoreflect.Message {
	mi := &file_ardapoc_rent_tx_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_MsgCancelCancellation_messageType fastReflection_MsgCancelCancellation_messageType
var _ protoreflect.MessageType = fastReflection_MsgCancelCancellation_messageType{}

type fastReflection_MsgCancelCancellation_messageType struct{}

func (x fastReflection_MsgCancelCancellation_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgCancelCancellation)(nil)
}
func (x fastReflection_MsgCancelCancellation_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgCancelCancellation)
}
func (x fastReflection_MsgCancelCancellation_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgCancelCancellation
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgCancelCancellation) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgCancelCancellation
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgCancelCancellation) Type() protoreflect.MessageType {
	return _fastReflection_MsgCancelCancellation_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgCancelCancellation) New() protoreflect.Message {
	return new(fastReflection_MsgCancelCancellation)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgCancelCancellation) Interface() protoreflect.ProtoMessage {
	return (*MsgCancelCancellation)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgCancelCancellation) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Creator != "" {
		value := protoreflect.ValueOfString(x.Creator)
		if !f(fd_MsgCancelCancellation_creator, value) {
			return
		}
	}
	if x.LeaseId != "" {
		value := protoreflect.ValueOfString(x.LeaseId)
		if !f(fd_MsgCancelCancellation_leaseId, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgCancelCancellation) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ardapoc.rent.MsgCancelCancellation.creator":
		return x.Creator != ""
	case "ardapoc.rent.MsgCancelCancellation.leaseId":
		return x.LeaseId != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ardapoc.rent.MsgCancelCancellation"))
		}
		panic(fmt.Errorf("message ardapoc.rent.MsgCancelCancellation does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCancelCancellation) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "ardapoc.rent.MsgCancelCancellation.creator":
		x.Creator = ""
	case "ardapoc.rent.MsgCancelCancellation.leaseId":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgCancelCancellation) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "ardapoc.rent.MsgCancelCancellation.creator":
		value := x.Creator
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message ardapoc.rent.MsgCancelCancellation does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCancelCancellation) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "ardapoc.rent.MsgCancelCancellation.creator":
		x.Creator = value.Interface().(string)
	case "ardapoc.rent.MsgCancelCancellation.leaseId":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCancelCancellation) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "ardapoc.rent.MsgCancelCancellation.creator":
		panic(fmt.Errorf("field creator of message ardapoc.rent.MsgCancelCancellation is not mutable"))
	case "ardapoc.rent.MsgCancelCancellation.leaseId":
		panic(fmt.Errorf("field leaseId of message ardapoc.rent.MsgCancelCancellation is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ardapoc.rent.MsgCancelCancellation"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgCancelCancellation) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "ardapoc.rent.MsgCancelCancellation.creator":
		return protoreflect.ValueOfString("")
	case "ardapoc.rent.MsgCancelCancellation.leaseId":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgCancelCancellation) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in ardapoc.rent.MsgCancelCancellation", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgCancelCancellation) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCancelCancellation) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgCancelCancellation) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgCancelCancellation) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgCancelCancellation)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgCancelCancellation: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgCancelCancellation: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_MsgCancelCancellationResponse protoreflect.MessageDescriptor
)

func init() {
	file_ardapoc_rent_tx_proto_init()
	md_MsgCancelCancellationResponse = File_ardapoc_rent_tx_proto.Messages().ByName("MsgCancelCancellationResponse")
}

var _ protoreflect.Message = (*fastReflection_MsgCancelCancellationResponse)(nil)

type fastReflection_MsgCancelCancellationResponse MsgCancelCancellationResponse

func (x *MsgCancelCancellationResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgCancelCancellationResponse)(x)
}

func (x *MsgCancelCancellationResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_ardapoc_rent_tx_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_MsgCancelCancellationResponse_messageType fastReflection_MsgCancelCancellationResponse_messageType
var _ protoreflect.MessageType = fastReflection_MsgCancelCancellationResponse_messageType{}

type fastReflection_MsgCancelCancellationResponse_messageType struct{}

func (x fastReflection_MsgCancelCancellationResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgCancelCancellationResponse)(nil)
}
func (x fastReflection_MsgCancelCancellationResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgCancelCancellationResponse)
}
func (x fastReflection_MsgCancelCancellationResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgCancelCancellationResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgCancelCancellationResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgCancelCancellationResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgCancelCancellationResponse) Type() protoreflect.MessageType {
	return _fastReflection_MsgCancelCancellationResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgCancelCancellationResponse) New() protoreflect.Message {
	return new(fastReflection_MsgCancelCancellationResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgCancelCancellationResponse) Interface() protoreflect.ProtoMessage {
	return (*MsgCancelCancellationResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgCancelCancellationResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgCancelCancellationResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ardapoc.rent.MsgCancelCancellationResponse"))
		}
		panic(fmt.Errorf("message ardapoc.rent.MsgCancelCancellationResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCancelCancellationResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ardapoc.rent.MsgCancelCancellationResponse"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgCancelCancellationResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ardapoc.rent.MsgCancelCancellationResponse"))
		}
		panic(fmt.Errorf("message ardapoc.rent.MsgCancelCancellationResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCancelCancellationResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ardapoc.rent.MsgCancelCancellationResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCancelCancellationResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ardapoc.rent.MsgCancelCancellationResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgCancelCancellationResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ardapoc.rent.MsgCancelCancellationResponse"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgCancelCancellationResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in ardapoc.rent.MsgCancelCancellationResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgCancelCancellationResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCancelCancellationResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgCancelCancellationResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgCancelCancellationResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgCancelCancellationResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgCancelCancellationResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgCancelCancellationResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
func (x *MsgPayRentResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *MsgPayRentResponse) GetAmountPaid() string {
	if x != nil {
		return x.AmountPaid
	}
	return ""
...
func (x *MsgPayRentResponse) GetAmountDisbursed() string {
	if x != nil {
		return x.AmountDisbursed
	}
	return ""
...
func (x *MsgPayRentResponse) GetOutstandingCleared() int32 {
	if x != nil {
		return x.OutstandingCleared
	}
	return 0
}
...
func (x *MsgCancelCancellation) Reset() {
	*x = MsgCancelCancellation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ardapoc_rent_tx_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgCancelCancellation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgCancelCancellation) ProtoMessage() {}

// Deprecated: Use MsgCancelCancellation.ProtoReflect.Descriptor instead.
func (*MsgCancelCancellation) Descriptor() ([]byte, []int) {
	return file_ardapoc_rent_tx_proto_rawDescGZIP(), []int{14}
}

func (x *MsgCancelCancellation) GetCreator() string {
	if x != nil {
		return x.Creator
	}
	return ""
...
func (x *MsgCancelCancellation) GetLeaseId() string {
	if x != nil {
		return x.LeaseId
	}
	return ""
...
func (x *MsgCancelCancellationResponse) Reset() {
	*x = MsgCancelCancellationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ardapoc_rent_tx_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgCancelCancellationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgCancelCancellationResponse) ProtoMessage() {}

// Deprecated: Use MsgCancelCancellationResponse.ProtoReflect.Descriptor instead.
func (*MsgCancelCancellationResponse) Descriptor() ([]byte, []int) {
	return file_ardapoc_rent_tx_proto_rawDescGZIP(), []int{15}
}
...
var file_ardapoc_rent_tx_proto_rawDesc = []byte{
	...
	,
	...
	,
}
...
var file_ardapoc_rent_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_ardapoc_rent_tx_proto_goTypes = []interface{}{
	...
	(*MsgCancelCancellation)(nil),           // 14: ardapoc.rent.MsgCancelCancellation
	(*MsgCancelCancellationResponse)(nil),   // 15: ardapoc.rent.MsgCancelCancellationResponse
	(*Params)(nil),                          // 16: ardapoc.rent.Params
}
var file_ardapoc_rent_tx_proto_depIdxs = []int32{
	16, // 0: ardapoc.rent.MsgUpdateParams.params:type_name -> ardapoc.rent.Params
	...
	14, // 8: ardapoc.rent.Msg.CancelCancellation:input_type -> ardapoc.rent.MsgCancelCancellation
	1,  // 9: ardapoc.rent.Msg.UpdateParams:output_type -> ardapoc.rent.MsgUpdateParamsResponse
	3,  // 10: ardapoc.rent.Msg.CreateLease:output_type -> ardapoc.rent.MsgCreateLeaseResponse
	5,  // 11: ardapoc.rent.Msg.UpdateLease:output_type -> ardapoc.rent.MsgUpdateLeaseResponse
	7,  // 12: ardapoc.rent.Msg.DeleteLease:output_type -> ardapoc.rent.MsgDeleteLeaseResponse
	9,  // 13: ardapoc.rent.Msg.PayRent:output_type -> ardapoc.rent.MsgPayRentResponse
	11, // 14: ardapoc.rent.Msg.InitiateCancellation:output_type -> ardapoc.rent.MsgInitiateCancellationResponse
	13, // 15: ardapoc.rent.Msg.ApproveCancellation:output_type -> ardapoc.rent.MsgApproveCancellationResponse
	15, // 16: ardapoc.rent.Msg.CancelCancellation:output_type -> ardapoc.rent.MsgCancelCancellationResponse
...
func file_ardapoc_rent_tx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ardapoc_rent_tx_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgCancelCancellation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ardapoc_rent_tx_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgCancelCancellationResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
