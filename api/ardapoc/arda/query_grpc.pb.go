...
const (
	Query_Params_FullMethodName        = "/ardapoc.arda.Query/Params"
	Query_Submission_FullMethodName    = "/ardapoc.arda.Query/Submission"
	Query_SubmissionAll_FullMethodName = "/ardapoc.arda.Query/SubmissionAll"
)
