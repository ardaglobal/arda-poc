...
const (
	Msg_UpdateParams_FullMethodName     = "/arda.property.Msg/UpdateParams"
	Msg_RegisterProperty_FullMethodName = "/arda.property.Msg/RegisterProperty"
)
...
func (c *msgClient) RegisterProperty(ctx context.Context, in *MsgRegisterProperty, opts ...grpc.CallOption) (*MsgRegisterPropertyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_RegisterProperty_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) RegisterProperty(context.Context, *MsgRegisterProperty) (*MsgRegisterPropertyResponse, error) {
...
func _Msg_RegisterProperty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_RegisterProperty_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
