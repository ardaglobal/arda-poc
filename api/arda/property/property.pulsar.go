...
func (x *Property) slowProtoReflect() protoreflect.Message {
	mi := &file_arda_property_property_proto_msgTypes[0]
...
func (x *fastReflection_Property) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "arda.property.Property.shares":
		return len(x.Shares) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: arda.property.Property"))
		}
		panic(fmt.Errorf("message arda.property.Property does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Property) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message arda.property.Property does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Property) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "arda.property.Property.region":
		panic(fmt.Errorf("field region of message arda.property.Property is not mutable"))
	case "arda.property.Property.value":
		panic(fmt.Errorf("field value of message arda.property.Property is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: arda.property.Property"))
		}
...
func (x *fastReflection_Property) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in arda.property.Property", d.FullName()))
	}
	panic("unreachable")
}
...
var file_arda_property_property_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x64, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x22, 0x98, 0x01,
	...
	,
}

var (
	file_arda_property_property_proto_rawDescOnce sync.Once
	file_arda_property_property_proto_rawDescData = file_arda_property_property_proto_rawDesc
)

func file_arda_property_property_proto_rawDescGZIP() []byte {
	file_arda_property_property_proto_rawDescOnce.Do(func() {
		file_arda_property_property_proto_rawDescData = protoimpl.X.CompressGZIP(file_arda_property_property_proto_rawDescData)
	})
...
func file_arda_property_property_proto_init() {
	if File_arda_property_property_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_arda_property_property_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_arda_property_property_proto_goTypes,
		DependencyIndexes: file_arda_property_property_proto_depIdxs,
		MessageInfos:      file_arda_property_property_proto_msgTypes,
	}.Build()
	File_arda_property_property_proto = out.File
	file_arda_property_property_proto_rawDesc = nil
	file_arda_property_property_proto_goTypes = nil
	file_arda_property_property_proto_depIdxs = nil
}
