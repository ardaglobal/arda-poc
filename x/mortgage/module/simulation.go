...
const (
	...
	opWeightMsgRepayMortgage = "op_weight_msg_repay_mortgage"
	// TODO: Determine the simulation weight value
	defaultWeightMsgRepayMortgage int = 100
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	var weightMsgRepayMortgage int
	simState.AppParams.GetOrGenerate(opWeightMsgRepayMortgage, &weightMsgRepayMortgage, nil,
		func(_ *rand.Rand) {
			weightMsgRepayMortgage = defaultWeightMsgRepayMortgage
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgRepayMortgage,
		mortgagesimulation.SimulateMsgRepayMortgage(am.accountKeeper, am.bankKeeper, am.keeper),
	))
...
func (am AppModule) ProposalMsgs(simState module.SimulationState) []simtypes.WeightedProposalMsg {
	return []simtypes.WeightedProposalMsg{
		...
		simulation.NewWeightedProposalMsg(
			opWeightMsgRepayMortgage,
			defaultWeightMsgRepayMortgage,
			func(r *rand.Rand, ctx sdk.Context, accs []simtypes.Account) sdk.Msg {
				mortgagesimulation.SimulateMsgRepayMortgage(am.accountKeeper, am.bankKeeper, am.keeper)
				return nil
			},
